 ...
 */
	...
	#include "ugfx/gos/chibios.h"
#elif GFX_USE_OS_FREERTOS
	#include "ugfx/gos/freertos.h"
#elif GFX_USE_OS_WIN32
	#include "ugfx/gos/win32.h"
#elif GFX_USE_OS_LINUX
	#include "ugfx/gos/linux.h"
#elif GFX_USE_OS_OSX
	#include "ugfx/gos/osx.h"
#elif GFX_USE_OS_IDF
#include "ugfx/gos/idf.h"
#elif GFX_USE_OS_NONE
#include "ugfx/gos/no_os.h"
#else
