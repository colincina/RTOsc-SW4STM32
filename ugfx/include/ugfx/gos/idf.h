...
//SAP #define gfxHalt(msg)				chDbgPanic(msg)
...
// Replace GTIMER with IDF one
// void gtimerStart(GTimer *pt, GTimerFunction fn, void *param, bool_t periodic, delaytime_t millisec)					
#define gtimerStart(pt, fn, param, periodic, millisec)  idfStartUgfxGTimer(pt, fn, param, periodic, millisec)			

void idfNotifyMouseInterrupt();
