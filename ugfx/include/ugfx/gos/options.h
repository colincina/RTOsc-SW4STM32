 ...
 */
	...
	#endif
	/**
	 * @brief   Use Interrupt Driven Framework (IDF)
	 * @details	Defaults to FALSE
	 */
	#ifndef GFX_USE_OS_IDF
		#define GFX_USE_OS_IDF			FALSE
	#endif
	/**
	 * @brief   Use no operating system
	 * @details	Defaults to FALSE
	 */
	#ifndef GFX_USE_OS_NONE
		#define GFX_USE_OS_NONE			FALSE
	#endif
/**
 * @}
 *
