...
#if !GFX_USE_OS_CHIBIOS && !GFX_USE_OS_FREERTOS && !GFX_USE_OS_WIN32 && !GFX_USE_OS_LINUX && !GFX_USE_OS_OSX && !GFX_USE_OS_IDF && !GFX_USE_OS_NONE
	#if GFX_DISPLAY_RULE_WARNINGS
		#warning "GOS: No Operating System has been defined.  (GFX_USE_OS_NONE) has been turned on for you."
	#endif
	#undef GFX_USE_OS_NONE
	#define GFX_USE_OS_NONE	TRUE
#endif
#if GFX_USE_OS_CHIBIOS + GFX_USE_OS_WIN32 + GFX_USE_OS_FREERTOS + GFX_USE_OS_LINUX + GFX_USE_OS_OSX + GFX_USE_OS_IDF + GFX_USE_OS_NONE != 1 * TRUE
