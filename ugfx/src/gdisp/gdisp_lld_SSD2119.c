...
#include "ugfx/gdisp/lld/gdisp_lld_config.h"
#include "ugfx/gdisp/lld/gdisp_lld.h"

#include "ugfx/gdisp/lld/board_SSD2119.h"
...
#include "ugfx/gdisp/lld/ssd2119.h"
...
LLDSPEC bool_t gdisp_lld_init(GDisplay* g) {
	...
	// Should wait 10 frames here, no idea what is the frame rate, so take 60Hz
	gfxSleepMilliseconds(166);
